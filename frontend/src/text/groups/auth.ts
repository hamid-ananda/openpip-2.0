...
export const authLabelsGroup: TextGroup = {
  ...
  entries: [
    { key: 'auth.divider', label: 'Divider between options', default: 'OR' },
    ...
    { key: 'auth.login.orcid', label: 'Login — ORCID button', default: 'Continue with ORCID' },
    ...
    {
      key: 'auth.register.orcid',
      label: 'Register — ORCID button',
      default: 'Continue with ORCID',
    },
    {
